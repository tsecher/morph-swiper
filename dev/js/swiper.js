...
/*#__PURE__*/
function () {
  function SVGSwiperClass($contianer) {
    _classCallCheck(this, SVGSwiperClass);

    this.$swiperContainer = $contianer;
    this.KUTE = __webpack_require__(/*! kute.js */ "./node_modules/kute.js/kute.js");
  ...
  _createClass(SVGSwiperClass, [{
    ...
    value: function init() {
      ...
      this.mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.swiper-container', {
        ...
        // centeredSlides: true,
        on: {
          slideChangeTransitionStart: function slideChangeTransitionStart(evt) {
            return _this.slideChangeTransitionStart(evt);
          }
        }
      });
    }
  }, {
    key: "slideChangeTransitionStart",
    value: function slideChangeTransitionStart(evt) {
      var _this2 = this;

      // Suppression du round.
      this.$swiperContainer.find('.rounded').each(function (i, n) {
        n = jquery__WEBPACK_IMPORTED_MODULE_0__(n);
        var index = n.attr('data-index');
        n.removeClass('rounded');

        _this2.KUTE.to('#rectangle-' + index, {
          path: '#square-' + index
        }, _this2.options).start();

        console.log('nex', index);
      }); // Passage en mode round.

      var $svg = this.$swiperContainer.find('.swiper-slide-active [data-index]');
      var svgId = $svg.attr('data-index');
      $svg.addClass('rounded');
      this.KUTE.to('#rectangle-' + svgId, {
        path: '#round-' + svgId
      }, this.options).start();
    }
  }, {
...
module.exports = __webpack_require__(/*! /Users/thomassecher/Sites/taf/test-parrot/src/js/swiper.js */"./js/swiper.js");
